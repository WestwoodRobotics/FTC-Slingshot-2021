...
//    Servo rightArm = null;
    ...
    public void runOpMode(){
        ...
        telemetry.update();
        motors[0].motor  = hardwareMap.get(DcMotorEx.class,           "left_Front");
        motors[1].motor  = hardwareMap.get(DcMotorEx.class,           "right_Front");
        motors[2].motor  = hardwareMap.get(DcMotorEx.class,           "left_Back");
        motors[3].motor  = hardwareMap.get(DcMotorEx.class,           "right_Back");
